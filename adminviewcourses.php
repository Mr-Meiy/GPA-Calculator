...
<center>
  <h2>VIEW COURSES</h2>
<form action="adminviewcourses.php" method="post">
  <table class="subj">
  <tr>
  ...
  <tr>  
  <td style="text-align:right;"> <label>Semester :</label> </td>
           ...
           if($result->num_rows)
            while($row=$result->fetch_object())
            {
                ...
                echo "<tr>
                      ...
                      <td id='cd' class='data'>{$ccode}</td>
                      <td id='cr' class='data'>{$credit}</td>
                    </tr>";
            }
          }
          else 
